...
class Transaction(TimestampModel):
    ...
    def save(self, *args, **kwargs):
        # expenditure_condition = self.expenditure_counterpart and self.type == constants.EXPENDITURE

        # try:
        #     income_condition = (
        #         self.income_counterpart and self.type == constants.INCOME
        #     )
    ...
    def exchange_rate(self):
        ...
        divisor = (
            self.expenditure_counterpart if self.is_income else self.income_counterpart
        )
